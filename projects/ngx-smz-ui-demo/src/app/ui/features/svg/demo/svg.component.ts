...
export class SvgComponent implements OnInit, AfterViewInit {
    ...
    this.mapData$ = this.http
      ...
      .pipe(
        map((svg: string) => {
          ...
          const [ pinMinWidth, pinMaxWidth ] = [ 0.2, 30 ];
          const [ pinWidth ] = [ pinMaxWidth ];
          ...
          const stateBuilder: SmzSvgBuilder = new SmzSvgBuilder()
            ...
            .useMouseZoom(1, 200, 0.2)
            .usePan()
            .setInitialScopes([])
            .executeAfterInit(() => {
                this.state.dispatch.setScopes.next(['mark']);
            ...
            .useWorldCoordinates()
              .addRefPoint({ latitude: -30.3752729, longitude: -51.107864, rootPosX: 397, rootPosY: 610})
              .addRefPoint({ latitude: 3.7298232, longitude: -64.7548833, rootPosX: 183, rootPosY: 45})
              .worldCoordinates
            .feature()
              .root(svg, width, height)
                ...
                .feature
              .pin(markSvgData, pinWidth)
                .addScope('mark')
                .setColor('red')
                .setCoordinates(-24.6487, -42.5147)
                .useTooltip('P-74')
                .useAdaptative(pinMinWidth, pinMaxWidth)
              .feature
              ...
              .pin(markSvgData, pinWidth)
                ...
                .setColor('red')
                .useTooltip('P-75')
                .setCoordinates(-24.7880, -42.5094)
                .useAdaptative(pinMinWidth, pinMaxWidth)
              .feature
              ...
              .pin(markSvgData, pinWidth)
                ...
                .setColor('red')
                .useTooltip('P-76')
                .setCoordinates(-24.6876, -42.5057)
                .useAdaptative(pinMinWidth, pinMaxWidth)
              .feature
              ...
              .pin(markSvgData, pinWidth)
                ...
                .setColor('red')
                .useTooltip('P-77')
                .setCoordinates(-24.6354, -42.4121)
                .useAdaptative(pinMinWidth, pinMaxWidth)
              .feature
  ...
  public moveToId(elementId: string): void {
    this.state.dispatch.zoomToId.next({ elementId, zoom: 1 });
  }

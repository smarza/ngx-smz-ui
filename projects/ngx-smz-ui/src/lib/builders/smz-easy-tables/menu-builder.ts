...
export class SmzMenuItemEasyTableBuilder {
  ...
  public askForConfirmation(title: string, message: string): SmzMenuItemEasyTableBuilder {
  ...
  public askForCriticalConfirmation(title: string, message: string): SmzMenuItemEasyTableBuilder {
    this._item.confirmable = {
      title,
      message,
      isCritical: true

...
export class SmzTimelineMenuBuilder {
  public items: SmzMenuItem[] = [];
  constructor(private _cardsBuilder: SmzTimelineBuilder<any>, protected _action: SmzCardActions<any>, items: SmzMenuItem[] = []) {
    this.items = items;
    _action.callback = null;
  }

  public useDynamic(callback: (row: any) => SmzMenuItem[]): SmzTimelineMenuBuilder {
  ...
  public separator(): SmzTimelineMenuBuilder {
  ...
  public setButtonClass(style: string): SmzTimelineMenuBuilder {
    this._action.buttonClass = style;
    return this;
  }

  public setIcon(style: string): SmzTimelineMenuBuilder {
    this._action.icon = style;
    return this;
  }

  public setStyleClass(style: string): SmzTimelineMenuBuilder {
...
export class SmzMenuItemCardsBuilder {
  constructor(private _menuBuilder: SmzTimelineMenuBuilder, private _parent: SmzMenuItemCardsBuilder, private _item: SmzMenuItem) {
  ...
  public get menu(): SmzTimelineMenuBuilder {

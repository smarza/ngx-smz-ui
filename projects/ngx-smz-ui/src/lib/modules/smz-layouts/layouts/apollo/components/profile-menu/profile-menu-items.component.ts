...
@Component({
  selector: "[smz-ui-apollo-profile-menu-items]",
    ...
    <li *ngFor="let item of items" [ngClass]="{ 'menuitem-active' : item.expanded }">
      ...
      <ng-container [ngSwitch]="item | hasChild">
        ...
        <ng-container *ngSwitchCase="true">
          ...
          <ul *ngIf="item.expanded" smz-ui-apollo-profile-menu-items [items]="item.items"></ul>
        </ng-container>
...
export class ApolloProfileMenuItemsComponent implements OnInit, AfterViewInit {

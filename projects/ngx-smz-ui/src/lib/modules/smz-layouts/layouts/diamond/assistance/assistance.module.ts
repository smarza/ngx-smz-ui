...
import { DiamondAssistanceComponent } from './assistance.component';
...
@NgModule({
  declarations: [DiamondAssistanceComponent],
  imports: [
    CommonModule,
    FormsModule,
    PrimeSharedModule,
  ...
  exports: [DiamondAssistanceComponent]
})
export class DiamondAssistanceModule { }

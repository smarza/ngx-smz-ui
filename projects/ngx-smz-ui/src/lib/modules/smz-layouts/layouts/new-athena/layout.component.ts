...
export class NewAthenaLayoutComponent implements OnInit, AfterContentInit {
  ...
  constructor(public readonly config: SmzLayoutsConfig, public readonly layout: NewAthenaLayout, public readonly routerListener: RouterDataListenerService, private store: Store, public cdr: ChangeDetectorRef) {

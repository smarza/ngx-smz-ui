...
@Component({
  ...
  template: `
      ...
      <a class="profile clickable grid align-items-center justify-content-end m-0 p-0 flex-nowrap gap-2" [ngClass]="{ 'profile-with-icon': !config.useAvatar }" (click)="toggle()">

...
import { DialogsState } from '../../modules/smz-dialogs/state/dialogs/dialogs.state';

export const UI_STATES: any[] = [LayoutUiState, NotificationsUiState, RouterParamsState, CommentsUiState, ExcelsUiState, DialogsState];

...
function buildVisibilityCondition() {
  return new SmzFormBuilder<{
    ...
    .validators()
    .required()
    .input.group.text('text1', 'Multiselect has Option 1')
    .setVisibilityFunction((formValues) =>
      formValues.multiselect1Ids?.includes('1')
    )
    .validators()
    .required()
    .input.group.checkbox('check2', 'Multiselect has Option 2')
    .setVisibilityFunction((formValues) =>
      formValues.multiselect1Ids?.includes('2')
    )
    .group.checkbox('check3', 'Multiselect has Option 3')
    .setVisibilityFunction((formValues) =>
      formValues.multiselect1Ids?.includes('3')
    )
    .group.radioGroup('inspectionDataLoadBehavior', 'Método de carregamento', [
...
function buildAllInputs() {
  return new SmzFormBuilder<any>()
    ...
    .validators()
    .required()
    .input.group.checkbox('info_input3', "I'm required")
    .setLayout('EXTRA_SMALL', 'col-4')
    .useLabel('Label Text')
    .validators()
    .required()
    .input.group.checkboxGroup('info_input4', "I'm required", [
      { id: '1', name: 'Option 1' },
      { id: '2', name: 'Option 2' },
      { id: '3', name: 'Option 3' },
    ])
    ...
    .validators()
    .required()
    .input.group.calendar('info_input2', 'Date', new Date())
    .setLayout('EXTRA_SMALL', 'col-4')
    .validators()
    .required()
    .input.group.dropdown('info_input6', "I'm required", [
      { id: '1', name: 'Option 1' },
      { id: '2', name: 'Option 2' },
      { id: '3', name: 'Option 3' },
    ])
    .validators()
    .required()
    .input.group.multiselect('info_input9', "I'm required", [
      { id: '1', name: 'Option 1' },
      { id: '2', name: 'Option 2' },
      { id: '3', name: 'Option 3' },
    ])
    .validators()
    .required()
    .input.group.colorPicker('info_input12', "I'm required")
    .validators()
    .required()
    .input.group.currency('metadata_input13', "I'm required")
    .validators()
    .required()
    .input.group.number('metadata_input14', 'Fraction Number')
    .setFraction(2, 2)
    .setLocale('pt-BR')
    .validators()
    .required()
    .input.group.radioGroup('metadata_input15', 'Radio', [
    ...
    .validators()
    .required()
    .input.group.switch('metadata_input16', 'IsContracted')
    .validators()
    .required()
    .input.group.password('metadata_input21', 'Password')
    .validators()
    .required()
    .input.group.form.build();
}
...
function buildCalendar() {
  return new SmzFormBuilder<any>()
    ...
    .group.calendar('input2', 'With default', new Date())
    .group.calendar('input3', "I'm required")
    .validators()
    .required()
    .input.group.form.build();
}
...
function buildCheckbox() {
  return new SmzFormBuilder<any>()
    ...
    .group.checkbox('input2', "I'm required")
    .validators()
    .required()
    .input.group.form.build();
}
...
function buildLinkedDropdown() {
  return new SmzFormBuilder<any>()
    ...
    .validators()
    .required()
    .input.group.linkedDropdown('year', 'plant', 'Ano', [
      {
        parentId: 'A',
        data: [
          { id: 'A1', name: '2024' },
...
function buildLinkedMultiselect() {
  return new SmzFormBuilder<any>()
    ...
    .validators()
    .required()
    .input.group.linkedMultiselect('input2', 'input1', "I'm required", [
      {
        parentId: 'A',
        data: [
...
function buildColorPicker() {
  return new SmzFormBuilder<any>()
    ...
    .group.colorPicker('input2', "I'm required")
    .validators()
    .required()
    .input.group.form.build();
}
...
function buildCurrency() {
  return new SmzFormBuilder<any>()
    ...
    .group.currency('input2', "I'm required")
    .validators()
    .required()
    .input.group.form.build();
}
...
function buildNumber() {
  return new SmzFormBuilder<any>()
    ...
    .group.number('input2', "I'm required")
    .validators()
    .required()
    .input.group.number('input3', 'Fraction Number')
    .setFraction(2, 2)
    .setLocale('pt-BR')
    .group.form.build();
}
...
function buildSwitch() {
  return new SmzFormBuilder<any>()
    ...
    .validators()
    .required()
    .input.group.switch('isContracted2', 'Disabled', true)
    .disable()
    .group.form.build();
}
...
function buildFile() {
  return new SmzFormBuilder<any>()
    ...
    .group.file('first', 'Confirmação First')
    .acceptImages()
    .validators()
    .required()
    .input.group.file('second', 'Confirmação Second')
    .validators()
    .required()
    .input.group.form.build();
}
...
function buildPasswordWithConfirmation() {
  return new SmzFormBuilder<any>()
    ...
    .validators()
    .required()
    .input.group.addPasswordConfirmation('password', 'Confirmation')
    .validators()
    .required()
    .input.group.form.build();
}
...
const SNIPPET_VISIBILITY = `// Campos visíveis conforme valor do multiselect (setVisibilityFunction).
new SmzFormBuilder()
  .group()
...
const SNIPPET_ALL_INPUTS = `// Exemplo com vários tipos de input no mesmo formulário.
new SmzFormBuilder<any>()
  .group()
    .text('info_input1', "I'm required", 'sample').validators().required().input
    .checkbox('info_input3', "I'm required").validators().required().input
    .calendar('info_input2', 'Date', new Date()).validators().required().input
    .dropdown('info_input6', "I'm required", options).validators().required().input
    .multiselect('info_input9', "I'm required", options).validators().required().input
    .currency('metadata_input13', "I'm required").validators().required().input
    .radioGroup('metadata_input15', 'Radio', options, 'Irregularidade')
    .switch('metadata_input16', 'IsContracted').validators().required().input
    .password('metadata_input21', 'Password').validators().required().input
    .form
  .build();`;
...
const SNIPPET_CALENDAR = `new SmzFormBuilder<any>()
  .group()
    ...
    .calendar('input3', "I'm required").validators().required().input
    .form
  .build();`;
...
const SNIPPET_CHECKBOX = `new SmzFormBuilder<any>()
  .group()
    .checkbox('input1', "I'm not required")
    .checkbox('input2', "I'm required").validators().required().input
    .form
  .build();`;
...
const SNIPPET_LINKED_DROPDOWN = `new SmzFormBuilder<any>()
  .group()
    .dropdown('plant', 'Planta', [{ id: 'A', name: 'Plant A' }, { id: 'B', name: 'Plant B' }], 'A')
      .validators().required().input
    ...
    ], 'A1').validators().required().input
    .form
  .build();`;

const SNIPPET_MULTISELECT = `new SmzFormBuilder<any>()
  .group()
    .multiselect('input1', "I'm required", options).validators().required().input
    .form
  .build();`;

const SNIPPET_LINKED_MULTISELECT = `new SmzFormBuilder<any>()
  .group()
    .dropdown('input1', 'Parent', parentOptions).validators().required().input
...
const SNIPPET_COLOR_PICKER = `new SmzFormBuilder<any>()
  .group()
    .colorPicker('input1', "I'm not required")
    .colorPicker('input2', "I'm required").validators().required().input
    .form
  .build();`;
...
const SNIPPET_CURRENCY = `new SmzFormBuilder<any>()
  .group()
    .currency('input1', "I'm not required")
    .currency('input2', "I'm required").validators().required().input
    .form
  .build();`;
...
const SNIPPET_NUMBER = `new SmzFormBuilder<any>()
  ...
  .group()
    .number('input1', "I'm not required")
    .number('input2', "I'm required").validators().required().input
    .number('input3', 'Fraction').setFraction(2, 2).setLocale('pt-BR')
    .form
  .build();`;
...
const SNIPPET_SWITCH = `new SmzFormBuilder<any>()
  .group()
    .switch('isContracted', 'IsContracted').validators().required().input
    .switch('disabled', 'Disabled', true).disable()
    .form
  .build();`;
...
const SNIPPET_TEXT = `new SmzFormBuilder<any>()
  .group()
    .text('input1', "I'm not required")
    .text('input2', "I'm required", 'sample').autoFocus().validators().required().input
    .form
  .build();`;

const SNIPPET_TEXT_BUTTON = `// TextButton com callback que valida e preenche outros campos.
new SmzFormBuilder<any>()
  .group('Chave correta: access')
    .textButton('key', 'Chave', '', (response, utils): Observable<{ isValid: boolean; messages?: string[] }> => {
      if (response.data.key === 'access') {
        utils.updateInputValue('name', 'user.name');
        return of({ isValid: true });
      }
      return of({ isValid: false, messages: ['Chave inválida'] });
    }).useLabel('Buscar').validators().required().input
  .form
  .group('Preenchimento automático')
    .text('name', 'Nome').disable()
    .text('email', 'Email').disable()
  .form
  .build();`;

const SNIPPET_FILE = `new SmzFormBuilder<any>()
  .group()
    .file('first', 'File').acceptImages().validators().required().input
    .file('second', 'Second').validators().required().input
    .form
  .build();`;
...
const SNIPPET_LIST_DIALOG = `new SmzFormBuilder<any>()
  .group()
    .list('input1', 'List', ['Option 1', 'Option 2'])
      .useDialogEditMode()
      .buttons().add().clear().edit().move().remove().sort().list
    .form
  .build();`;
...
const SNIPPET_PASSWORD = `new SmzFormBuilder<any>()
  .group()
    .password('password', 'Password').validators().required().input
    .form
  .build();`;
...
const SNIPPET_PASSWORD_CONFIRMATION = `new SmzFormBuilder<any>()
  .group()
    .password('password', 'Password').validators().required().input
    .addPasswordConfirmation('password', 'Confirmation').validators().required().input
    .form
  .build();`;

const SNIPPET_TAG_AREA = `new SmzFormBuilder<any>()
  .group()
    .tagArea('description', 'Descrição').validators().required().input
      .setTagCharacters('<', '>').addOption('#', [{ id: 'M0-10', value: 'M0-10' }])
    .form
  .build();`;

const SNIPPET_MULTIPLE_GROUPS = `// Grupos visíveis conforme dropdown (addGroupReaction).
new SmzFormBuilder<any>()
  .runCustomFunctionsOnLoad()
  .group('Main')
    .dropdown('input1', 'Choose', [
      { id: 'both', name: 'Show Both' }, { id: '1', name: 'Group 1' }, { id: '2', name: 'Group 2' },
    ], 'both')
    .addGroupReaction('group1', (opt) => opt.id === '1' || opt.id === 'both')
    .addGroupReaction('group2', (opt) => opt.id === '2' || opt.id === 'both')
  .form
  .group('Group 1', 'group1').hide()
    .dropdown('country1', 'Países', [...])
  .form
  .group('Group 2', 'group2').hide()
    .dropdown('country2', 'Países', [...])
  .form
  .build();`;

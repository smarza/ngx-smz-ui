...
import { DemoDynamicComponent } from './components/demo-dynamic/demo-dynamic.component';
...
@NgModule({
  ...
  imports: [
    ...
    FileUploadModule,
    StandaloneInjectComponentDirective
  ],
  providers: [],

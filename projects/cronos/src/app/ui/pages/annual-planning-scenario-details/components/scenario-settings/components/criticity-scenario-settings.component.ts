...
@Component({
  selector: 'app-criticity-scenario-settings',
  standalone: true,
...
export class CriticityScenarioSettingsComponent implements OnInit {
  private readonly store: Store = inject(Store);
  @Input() public scenario: ScenarioDetails;
  public general: UpdateScenarioWithCriticityStrategy;
  public teams: FixedTeamData[];
  public formData: StrategyFormData<UpdateScenarioWithCriticityStrategy, FixedTeamData>;
  ...
  public getGeneralData(general: UpdateScenarioWithCriticityStrategy): void {
  ...
  public enableEditing(): void {
    ...
    setTimeout(() => {
      ...
      this.formData = getCriticityStrategyFormData(this.scenario, annualPlanning, this.isEditing);
    }, 0);
  }
  ...
  public updateScenario(): void {
    const payload: UpdateScenarioWithCriticityStrategy = {
      ...this.general,
  ...
  public confirmPlanRecalculation(payload: UpdateScenarioWithCriticityStrategy): void {
    this.store.dispatch(new ScenariosFtActions.UpdateScenarioWithCriticityStrategy(payload))
  ...
  public confirmScenarioRecalculation(payload: UpdateScenarioWithCriticityStrategy): void {
    this.store.dispatch(new ScenariosFtActions.UpdateScenarioWithCriticityStrategy(payload))
      .subscribe(() => this.location.back());
  }
}
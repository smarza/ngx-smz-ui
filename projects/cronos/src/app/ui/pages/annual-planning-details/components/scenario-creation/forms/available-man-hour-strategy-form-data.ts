...
export function getAvailableManHourStrategyFormData(annualPlanning: AnnualPlanningDetails): StrategyFormData<CreateScenarioWithAvailableManHourStrategy, FixedTeamData> {

  const generalForm = new SmzFormBuilder<CreateScenarioWithAvailableManHourStrategy>()
    .group('Dados Gerais')
      .text(nameof<CreateScenarioWithAvailableManHourStrategy>('name'), 'Nome')
      ...
      .form
    .group()
      .radioGroup(nameof<CreateScenarioWithAvailableManHourStrategy>('defaultCorrosion'), 'Ignorar sistemas abaixo do índice padrão', [{id: true, name: 'Sim'}, {id: false, name: 'Não'}], false)
        ...
        .group
      .radioGroup(nameof<CreateScenarioWithAvailableManHourStrategy>('considerProximity'), 'Considerar proximidade', [{id: true, name: 'Sim'}, {id: false, name: 'Não'}], false)
        .overrideResponseFormat('IdOnly')
        ...
        .validators().required().input
        .group
      .number(nameof<CreateScenarioWithAvailableManHourStrategy>('corrosionGoal'), 'Meta de Corrosão (%)', 0)
        .setLayout('EXTRA_LARGE', 'col-3')
        .setLayout('LARGE', 'col-3')
        .setLayout('MEDIUM', 'col-12')
        .setLayout('SMALL', 'col-12')

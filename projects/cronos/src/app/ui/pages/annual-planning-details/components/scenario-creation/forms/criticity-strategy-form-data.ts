...
export function getCriticityStrategyFormData(annualPlanning: AnnualPlanningDetails): StrategyFormData<CreateScenarioWithCriticityStrategy, FixedTeamData> {

  const generalForm = new SmzFormBuilder<CreateScenarioWithCriticityStrategy>()
    .group('Dados Gerais')
      .text(nameof<CreateScenarioWithCriticityStrategy>('name'), 'Nome')
      ...
      .form
    .group()
      .radioGroup(nameof<CreateScenarioWithCriticityStrategy>('defaultCorrosion'), 'Ignorar sistemas abaixo do índice padrão', [{id: true, name: 'Sim'}, {id: false, name: 'Não'}], false)
        ...
        .group
      .radioGroup(nameof<CreateScenarioWithCriticityStrategy>('considerProximity'), 'Considerar proximidade', [{id: true, name: 'Sim'}, {id: false, name: 'Não'}], false)
        .overrideResponseFormat('IdOnly')
        ...
        .validators().required().input
        .group
      .number(nameof<CreateScenarioWithCriticityStrategy>('corrosionGoal'), 'Meta de Corrosão (%)', 0)
        .setLayout('EXTRA_LARGE', 'col-3')
        .setLayout('LARGE', 'col-3')
        .setLayout('MEDIUM', 'col-12')
        .setLayout('SMALL', 'col-12')
